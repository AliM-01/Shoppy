...
public class GetInventoryQueryHandler : IRequestHandler<GetInventoryDetailsQuery, Response<EditInventoryDto>>
{
    #region Ctor
    ...
    public GetInventoryQueryHandler(IGenericRepository<Domain.Inventory.Inventory> inventoryRepository, IMapper mapper)
    {

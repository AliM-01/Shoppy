...
public class GetProductFeatureDetailsQueryHandler : IRequestHandler<GetProductFeatureDetailsQuery, Response<EditProductFeatureDto>>
{
    ...
    public GetProductFeatureDetailsQueryHandler(IGenericRepository<Domain.ProductFeature.ProductFeature> productFeatureRepository, IMapper mapper)
    {
    ...
    {
        var ProductFeature = await _productFeatureRepository.GetEntityById(request.Id);

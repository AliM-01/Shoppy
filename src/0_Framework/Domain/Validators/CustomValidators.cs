...
public static class CustomValidators
{
    ...
    public static IRuleBuilder<T, string> RequiredValidator<T>(this IRuleBuilder<T, string> ruleBuilder, string propertyName)
    {
        return ruleBuilder
    ...
    public static IRuleBuilder<T, Guid> RequiredValidator<T>(this IRuleBuilder<T, Guid> ruleBuilder, string propertyName)
    {
        return ruleBuilder
            .NotEmpty()
                   .WithMessage(string.Format("لطفا {0} را وارد کنید", propertyName));
    ...
    public static IRuleBuilder<T, long> RangeValidator<T>(this IRuleBuilder<T, long> ruleBuilder, string propertyName, int min, int max)
    {
    ...
    public static IRuleBuilder<T, string> MaxLengthValidator<T>(this IRuleBuilder<T, string> ruleBuilder, string propertyName, int maxLength)
    {
        return ruleBuilder
    ...
    public static IRuleBuilder<T, string> MinLengthValidator<T>(this IRuleBuilder<T, string> ruleBuilder, string propertyName, int maxLength)
    {
        return ruleBuilder
    ...
    public static IRuleBuilder<T, string> CustomEmailAddressValidator<T>(this IRuleBuilder<T, string> ruleBuilder)
    {
        return ruleBuilder
            .EmailAddress()
            .WithMessage(string.Format("ایمیل وارد شده نامعتبر است"));
    }
    ...
    public static IRuleBuilder<T, string> MobileValidator<T>(this IRuleBuilder<T, string> ruleBuilder)
    {
        ...
        return ruleBuilder
            ...
            .Matches(regex)
            .WithMessage(string.Format("شماره موبایل وارد شده نامعتبر است"));
    }
